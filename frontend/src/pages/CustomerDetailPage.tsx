...
// import { getInteractionsByCustomerId } from '../services/interactionService';
...
const CustomerDetailPage: React.FC = () => {
  ...
  useEffect(() => {
    ...
    // getCustomerById(parseInt(id!, 10)).then(data => setCustomer(data));
    // getInteractionsByCustomerId(parseInt(id!, 10)).then(data => setInteractions(data.interactions));
  ...
  const handleDelete = () => {
    if (window.confirm('Are you sure you want to delete this customer?')) {
      ...
      // deleteCustomer(parseInt(id!, 10)).then(() => {
      //   navigate('/customers');
      // });
